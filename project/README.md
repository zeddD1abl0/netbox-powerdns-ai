...
|---|---|---|---|
| [M00](milestones/M00-foundation.md) | Foundation | in-progress | 8 of 12 |
...
|---|---|---|---|---|
| [ITEM-0006](items/ITEM-0006-makefile-and-ci-wrappers.md) | Makefile and thin CI wrappers for GitLab and GitHub | task | open | — |
| [ITEM-0007](items/ITEM-0007-lint-configuration.md) | Lint configuration for Go, OpenAPI and documentation | task | open | — |
| [ITEM-0008](items/ITEM-0008-docs-site.md) | Documentation site build and theme spike | task | open | — |
| [ITEM-0011](items/ITEM-0011-cold-start-test.md) | Cold-start test and M0 close | task | open | ITEM-0006, ITEM-0007, ITEM-0008 |
